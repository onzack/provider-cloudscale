...
//go:generate go run github.com/crossplane/upjet/v2/cmd/scraper -n ${TERRAFORM_PROVIDER_SHORT_NAME} -r ../.work/${TERRAFORM_PROVIDER_SHORT_NAME}/${TERRAFORM_DOCS_PATH} -o ../config/provider-metadata.yaml
