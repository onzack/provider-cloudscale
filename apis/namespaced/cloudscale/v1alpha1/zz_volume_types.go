...
type VolumeInitParameters struct {
	...
	// References to Server in cloudscale to populate serverUuids.
	// +kubebuilder:validation:Optional
	ServerUuidsRefs []v1.NamespacedReference `json:"serverUuidsRefs,omitempty" tf:"-"`

	// Selector for a list of Server in cloudscale to populate serverUuids.
	// +kubebuilder:validation:Optional
	ServerUuidsSelector *v1.NamespacedSelector `json:"serverUuidsSelector,omitempty" tf:"-"`
